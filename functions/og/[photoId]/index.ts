// EdgeOne Pages Function: Serve per-photo OG image
// /og/{photoId} → redirect to static OG image or fallback to thumbnail
...
export async function onRequest(context: { request: Request; params: Record<string, string> }) {
  ...
  // Prefer the generated OG image, fallback to thumbnail
